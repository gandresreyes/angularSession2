...
export interface SerchGisfResponse {
    data:       Gif[];
...
export class Convert {
    public static toSerchGisfResponse(json: string): SerchGisfResponse {
        return cast(JSON.parse(json), r("SerchGisfResponse"));
    }

    public static serchGisfResponseToJson(value: SerchGisfResponse): string {
        return JSON.stringify(uncast(value, r("SerchGisfResponse")), null, 2);
    }
}
